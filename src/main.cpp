...
int main(int argc, char **argv)
{
	...
	// Print the console splash and get on with loading the program
        QString versionLine = QString("This is %1 (v%2) - %3").arg(StelUtils::getApplicationName(), StelUtils::getApplicationVersion(), ZAP_URL);
        QString copyrightLine = ZAP_COPYRIGHT;
